...
## Steps
1. [ ] Create a `.github/copilot-instructions.md` or `.vscode/settings.json` rule set.
2. [ ] Instruct the native agent to always look at `agents/roles/` before execution.
3. [ ] Run the first product discovery session using the native chat window.
